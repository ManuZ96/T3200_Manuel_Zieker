...
Bei den Integrationstests werden alle \gls{led}-Stränge gleichzeitig verwendet und auch der Boot-Modus, der über die \gls{led}s mehrerer Funktionen läuft, getestet.  
...
Die erste Dimensionierung des Netzteils erfolgt auf Grundlage der theoretisch maximal gleichzeitig aktivierten \gls{led}s innerhalb eines Zeitraums von zwei Sekunden.  
...
Während der Inbetriebnahme zeigt sich jedoch ein Einbruch der Versorgungsspannung beim Startvorgang. 
...
Dabei wird insbesondere beobachtet, ob Sekunden- und Minutenwechsel korrekt dargestellt werden und diese in Echtzeit erfolgen oder es bei der Verarbeitung zu Verzögerungen kommt.  
...
Ab dem Bereich „zwanzig nach“ war der Bezug zur folgenden Stunde zunächst nicht korrekt.  
