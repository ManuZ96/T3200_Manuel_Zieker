\section{Abnahme}
Die Abnahme erfolgt durch einen abschließenden Vergleich der umgesetzten Funktionen mit den aus der Anforderungsanalyse in Kapitel~4 definierten Anforderungen.
...
Die Abb.~\ref{fig:Montiert} zeigt das Ergebnis dieser Studienarbeit, die entwickelte WordClock an ihrem Installationsort.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{inhalt/bilder/Finale.png}
    \caption[Erfolgreich inbetriebgenommene WordClock]{Die in dieser Studienarbeit entwickelte, konstruierte, aufgebaute und erfolgreich inbetriebgenommene WordClock verfügt über funktionale Zusatzinformationen und eine Smart-Home-Integration. Zum Zeitpunkt der Aufnahme zeigt die WordClock an, dass es in Remseck neun Minuten nach halb zwei mittags ist. Es herrschen frische Temperaturen und ein bewölkter Himmel. Weiterhin befindet sich die Mondphase gerade am Anfang und zeigt eine zunehmenden Sichel. Im Raum liegt die Luftfeuchtigkeit zwischen 40 und 50 Prozent bei einer Raumtemperatur zwischen 23 und 24 Grad.}
    \label{fig:Montiert}
\end{figure}  