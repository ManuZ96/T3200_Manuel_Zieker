...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.47\linewidth]{inhalt/bilder/KaskadeLED.png}
	\caption[Schaltbild zur Kaskadierung von RGB-LEDs]{Schaltbild zur Kaskadierung von \glsdisp{ws2812b}{adressierbaren RGB-LEDs mit integrierter Steuerelektronik (WS2812B)} und einer Versorgungsspannung von +5V. Mit VDD als Versorgungsspannung, DIN als Datensignal-Eingang, DOUT als Datensignal-Ausgang und VSS als Ground~\cite{Worldsemi2013}.}
