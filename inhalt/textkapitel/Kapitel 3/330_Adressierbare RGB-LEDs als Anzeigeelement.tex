...
\begin{figure}[H]
	...
	\caption[Schaltbild zur Kaskadierung]{Schaltbild zur Kaskadierung von \gls{ws2812b} \gls{led}s mit einer Versorgungsspannung von +5V. Mit VDD als Versorgungsspannung, DIN als Datensignal Eingang, DOUT als Datensignal Ausgang und VSS als Ground~\cite{Worldsemi2013}.}
