...
Die Hardwarearchitektur basiert auf einem Mikrocontroller mit integrierter WLAN-Schnittstelle.
Dieser übernimmt sowohl die Datenverarbeitung als auch die Kommunikation mit externen Diensten.

Die Anzeige erfolgt über mehrere LED-Streifen mit WS2812B RGB-Leuchtdiode.
Eine LED-Streifen wird für die Hauptanzeige verwenet. Das ist die Uhrzeit in Stunden und Minuten, die Außentemperautur und das Wetter.
Der zweite LED-Streifen wird für die Sekundenanzeige verwendet.
Der dritte LED-Streifen für die Anzeige der Zusatzfunktionen Tageszeit, Raumfeuchtigkeit, Mondphase und Innenraumtemperatur verwendet.
...
Zentrale Komponenten sind die Zeitverarbeitung, die LED-Ansteuerung sowie die Kommunikation mit externen Diensten.
