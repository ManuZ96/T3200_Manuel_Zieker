...
Die Anzeige erfolgt über mehrere \gls{led}-Stränge die aus vorgefertigen \gls{led}-Streifen bestehen und mit \gls{ws2812b} \gls{rgb}-Leuchtdiode bestückt sind. \todo{angeben welche led bänder}
Ein \gls{led}-Strang wird für die Hauptanzeige verwendet. Das ist die Uhrzeit in Stunden und Minuten, die Außentemperautur und das Wetter.
