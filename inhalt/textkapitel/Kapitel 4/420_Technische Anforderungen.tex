...
Die Anzeige erfolgt über mehrere \gls{led}-Stränge, die aus vorgefertigen \gls{led}-Streifen von AZ-Delivery bestehen und mit \gls{ws2812b} \gls{rgb}-Leuchtdioden bestückt sind~\cite{AZDelivery}.
Ein \gls{led}-Strang wird für die Hauptanzeige verwendet: die Uhrzeit in Stunden und Minuten, die Außentemperatur und das Wetter.
Der zweite \gls{led}-Strang wird für die Sekundenanzeige verwendet.
Der dritte \gls{led}-Strang wird für die Anzeige der Tageszeit, der Raumfeuchtigkeit, der Mondphase und der Innenraumtemperatur verwendet.
...
H3 & Drei kaskadierte LED-Stränge mit je einem Datenpin am Mikrocontroller \\
