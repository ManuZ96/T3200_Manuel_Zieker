...
Die \gls{led}-Ansteuerung ist in drei separate \gls{led}-Stränge unterteilt, wobei jeder Strang aus mehreren unterschiedlich langen \gls{led}-Streifen besteht.
Diese sind galvanisch durch Lötverbindungen gekoppelt, um die Signal- und Stromführung über Kurven zu realisieren.
Der erste Strang hat 256 \gls{ws2812b}-\gls{led}s und wird für die Anzeige von Stunden und Minuten, der Außentemperatur und des Wetter verwendet.  
...
Im ungünstigsten Fall sind während des Boot-Modus kurzzeitig alle 256 LEDs des Hauptstreifens bei voller Helligkeit gleichzeitig aktiv. 
Daraus ergibt sich die maximale Gesamtleistung zu  
\[
