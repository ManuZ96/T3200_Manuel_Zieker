...
Nach dem Öffnen der Benutzeroberfläche werden im ersten Segement: „Anzeige“ die aktuellen Statusinformationen der WordClock angezeigt.  
...
Diese öffnet sich wenn man auf die aktuelle im Segment angezeigte Farbe drückt (vgl. Abb.~\ref{fig:APIFarbe2}).
...
Im letzte Segment „API“ kann man das \gls{json}-Statusfile aufrufen dass die Werte für die Oberfläche bereitstellt und in dem die genauen Variablennamen aufgeführt sind (vgl. Abb.~\ref{fig:Json}).
...
\begin{figure}[H]
  \centering
	...
	\begin{subfigure}{0.55\textwidth}
      ...
      \label{fig:Json2}
	\end{subfigure}
	\caption{Abruf des \gls{json}-Statusfile über die \gls{ui}.}
  \label{fig:Json}
\end{figure}