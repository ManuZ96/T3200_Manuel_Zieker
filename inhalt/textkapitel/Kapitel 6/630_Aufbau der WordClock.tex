...
Dadurch kann überprüft werden, ob die korrekten Wörter angezeigt werden und die korrekte \gls{led} angsprochen wird.  
...
\begin{figure}[H]
	...
	\caption[Installation aller \gls{led}-Stränge]{Installation aller \gls{led}-Stränge auf der Grundplatte.}
