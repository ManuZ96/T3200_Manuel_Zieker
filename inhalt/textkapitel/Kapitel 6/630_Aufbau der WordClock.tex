...
Für den \gls{led}-Strang der Sekundenanzeige werden vier weitere Bauteile gedruckt, um die \gls{led}-Bänder um die Kurve zu führen.
...
\begin{figure}[H]
	...
	\caption[Installation aller \gls{led}-Stränge]{Grundplatte während der Installation und des Verlötens der einzelnen \gls{led}-Streifen zu den drei \gls{led}-Strängen. In den Ecken der Grundplatte befinden sich die Bauteile, über die die \gls{led}-Bänder um die Kurve geführt werden.}
	\label{fig:VerlötetStreifen}
\end{figure}
Die Verbindung der Frontplatte zur Grundplatte erfolgt über die Eckteile.  
Hierzu werden Gewindeeinsätze, sogenannte Heatinserts, eingesetzt, die in das 3D-gedruckte Material integriert werden.
...
\end{figure}  
Die Befestigung erfolgt anschließend mit M4 $\times$ 20~mm-Schrauben.  
Die Verbindung der einzelnen Frontplattenbauteile untereinander erfolgt über Durchgangsbohrungen.  
Hierbei werden M3 $\times$ 12~mm-Schrauben in Kombination mit Muttern und Unterlegscheiben verwendet.
...
\begin{figure}[H]
	...
	\caption[Der für die Inbetriebnahme verwendete elektrische Aufbau]{Der für die Inbetriebnahme verwendete elektrische Aufbau und der Anschluss des Mikrocontrollers, welcher zunächst aus Jumperkabeln, Klemmen und dreipoligen Steckverbindern besteht.}
	\label{fig:TischIBN}
\end{figure}