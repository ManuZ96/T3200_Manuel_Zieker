...
Die Indexnummern der einzelnen \gls{led}s werden zur einfacheren Verwendung im Code globalen Variablen zugeordnet, welche die jeweiligen Wörter repräsentieren. 
...
Die zentrale Anzeigefunktion löscht zunächst den Hauptstreifen und aktiviert anschließend die benötigten Wörter für Stunden, Minuten, Wetter- und Außentemperaturinformationen (vgl. Skript~\ref{lst:WortSetzen}).
