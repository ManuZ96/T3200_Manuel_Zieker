...
Diese Boxen sind in Abbildung~\ref{fig:3DDruckbeispiel} zu sehen.
...
Die Sekundenanzeig ist am Außenrand der Frontplatte mit 60 Schlitzen realisiert (vgl. Abb.~\ref{fig:Frontplatte}).
...
Außerdem werden Halterungen für verschieden Anwendungszwecke konstruiert und gedruckt.
...
Diese wird ebenfalls an der Rückseite montiert, so dass der Hohlstecker des +5V Netzteils ein und ausgesteckt werden kann, ohne die WordClock von der Wand nehmen zu müssen (vgl. Abb.~\ref{fig:HohlsteckerHalter}).
