...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\linewidth]{inhalt/bilder/Bauteil11_gedruckt.png}
...
Weiterhin wird eine Halterung für den Mikrocontroller entwickelt, die an der Rückseite der Multiplexplatte montiert ist.  
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        ...
        \caption{3D-gedruckte Montageplatte für den \gls{esp32c6}, die an der Rückseite montiert wird.}
