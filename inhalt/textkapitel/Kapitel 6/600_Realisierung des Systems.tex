...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Ablauf des Boot-Modus der WordClock um dem Nutzer anzuzeigen, dass diese gerade startet und die Werte abgerufen und initialisiert werden.}
...
Auf Basis der ermittelten Schriftgröße geht die Gesamtgröße der WordClock hervor.
