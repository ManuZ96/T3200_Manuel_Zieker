...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.4\textwidth}
        ...
        \caption{Alle LEDs sind kurz aus. Wenn die Wortuhr alles fertig geladen hat, geht die Wortuhr in den Anzeigemodus, ansonsten beginnt der ablauf von vorne.}
        \label{fig:Konzeptentwicklung_bootD}
    \end{subfigure}
    \caption{Dargestellt ist der Boot-Modus der Wortuhr um dem Nutzer anzuzeigen, dass die Uhr am hochfahren ist und aktuell die Werte abgerufen und geladen werden.}
...
Auf Basis der ermittelten Schriftgröße geht die Gesamtgröße der Wortuhr hervor.
