...
Hierzu zählen die Anzeige von Wetter- und Temperaturdaten, der Tageszeit, der aktuelle Mondphase sowie die Integration eines Innenraumsensors zur Erfassung von Temperatur und Luftfeuchtigkeit. 
Die Daten werden in definierten Zeitintervallen aktualisiert und anschließend in abstrahierter Form dargestellt. 
Der Ablauf ist in Abb.~\ref{fig:erweiterung} dargestellt.
...
\end{tikzpicture}
\caption[Schematischer Programmablaufplan für Anzeige der Zusatzfunktionen]{Schematischer Programmablaufplan zur Erzeugung der Anzeige für die WordClock, welche die informativen Zusatzfunktionen darstellt.}
