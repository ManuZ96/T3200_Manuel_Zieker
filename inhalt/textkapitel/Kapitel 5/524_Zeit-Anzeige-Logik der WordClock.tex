\subsection{Zeit-Anzeigen-Logik der WordClock}
...
Die Anzeige erfolgt durch gezielte Aktivierung von einzelnen \gls{led}s, welche die benötigten Buchstaben der Wörter ausleuchten. 
Der Ablauf der Anzeigeerzeugung ist in Abb.~\ref{fig:WordClock11} dargestellt.
...
\end{tikzpicture}
\caption[Schematischer Programmablaufplan Zeit-Anzeige-Logik]{Schematischer Programmablaufplan zur Erzeugung der Zeit-Anzeige-Logik der WordClock.}
