...
\begin{figure}[H]
	...
	\caption{Waveshare ESP32-C6-DEV-KIT-N8}
    \label{fig:ESP32C6}
\end{figure}
...
Mit der integrierter \gls{wlan}-Schnittstelle ist eine flexible Integration in vernetzte Anwendungen möglich und der \gls{esp32c6} kann als eigenständiges System betrieben werden. 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{inhalt/bilder/ESP32-C6-DEV-KIT-N8_Peripherals.png}
	\caption{Pinout des Waveshare ESP32-C6-DEV-KIT-N8}
