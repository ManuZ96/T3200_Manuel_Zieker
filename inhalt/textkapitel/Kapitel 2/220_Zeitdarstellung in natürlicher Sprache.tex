\section{Zeitdarstellung in natürlicher Sprache} \todo{Jessi gegenlesen ob sinnig}
...
% Wortmapping
% Unterschied: digitale (HH:MM) vs. sprachliche Zeitdarstellung
% Linguistische Struktur der Uhrzeit im Deutschen
% regionale Unterschiede (z. B. „Viertel drei“ vs. „Viertel nach zwei“)
% Logik: Bezug auf nächste Stunde („halb drei“)
% diskrete Zeitintervalle (5-Minuten-Schritte + Feinauflösung)
% kognitive Vorteile (intuitiver, alltagssprachlich)
% Mapping Zeit → Wörter → LEDs
% Sonderfälle: „ein Uhr“ vs. „eins“
