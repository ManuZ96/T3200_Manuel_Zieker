...
Bei der QLOCKTWO CLASSIC ist z.B. eine Sekundenanzeige grundsätzlich möglich, erfordert jedoch, dass diese durch Drücken eines Knopfes ein- und ausgeschaltet wird.
...
Die entwickelte WordClock soll die folgenden, grundlegenden und zusätzlichen Funktionen aufweisen und darstellen (vgl. Tabelle~\ref{tab:SollFunktionen})
