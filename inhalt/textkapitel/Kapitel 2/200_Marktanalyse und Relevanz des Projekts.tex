...
\begin{figure}[H]
	...
	\caption{WordClock Earth45 im Design Desert von QLOCKTWO für einen Kaufpreis von 2.690,00€~\cite{QlockTwoDesertBild}.}
...
Ein Beispiel hierfür ist die WordClock Jupiter, die je nach Ausführung in einem Preisbereich von etwa 200 € bis 600 € liegt~\cite{wordclock_jupiter}. 
...
\begin{figure}[H]
	...
	\caption{Beispiel der Tischwortuhr, über Alibaba.com bestellbar für einen Kaufpreis von <20€ bei abnahme einer entsprechend großen Stückzahl~\cite{alibaba_wordclock_bild}.}
...
\begin{table}[H]
\caption{Vergleich verschiedener WordClock in verschiedenen Preissegmenten anhand selbst definierter Kriterien}
\centering
...
\begin{table}[h]
\caption{Bewertung der verschiedenen Preissegmente und Definition der angestrebten Werte der entwickelten WordClock}
\centering
